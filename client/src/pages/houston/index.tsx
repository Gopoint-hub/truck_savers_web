...
const houstonServices = [
  ...
  { slug: 'balanceo-de-camiones', title: 'Balanceo de Camiones', description: 'Servicio de balanceo profesional para llantas de camiones y trailers.' },
  ...
  { slug: 'reparacion-de-cardanes', title: 'Reparación de Cardanes', description: 'Servicio especializado en reparación de cardanes y transmisión.' },
  { slug: 'mofles', title: 'Taller de Mofles', description: 'Reparación y reemplazo de sistemas de escape para camiones.' },
  { slug: 'cambio-reten-de-maza', title: 'Cambio Retén de Maza', description: 'Servicio de cambio de retenes de maza para camiones.' },
