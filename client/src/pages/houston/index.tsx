...
const houstonServices = [
  { slug: 'auto-pickup-repair', title: 'Auto / Pickup Repair', description: 'Diagnóstico con El Bailador, reparación de suspensión, dirección y alineación para pickups y autos.' },
  ...
  { slug: 'taller-de-frenos', title: 'Taller de Frenos', description: 'Especialistas en reparación y mantenimiento de sistemas de frenos para camiones.' },
  { slug: 'direccion', title: 'Dirección', description: 'Reparación de sistemas de dirección hidráulica para camiones.' },
  ...
  { slug: 'balanceo-de-llantas', title: 'Balanceo de Llantas', description: 'Servicio de balanceo profesional de morenas para camiones y remolques.' },
  { slug: 'reparacion-de-neumaticos', title: 'Depilada de Llantas', description: 'Reparación profesional de llantas para camiones comerciales.' },
