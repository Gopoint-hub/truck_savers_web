...
export default function SelladorLlantasDallas() {
  const serviceData = {
    title: "Sellador de Llantas Salvamorenas en Dallas, TX",
    subtitle: "Protector y sellador para tus morenas en Dallas - ¡No te quedes parado en la ruta!",
    heroImage: "/images/thetrucksavers-7.webp",
    description:
      "En The Truck Savers Dallas, nuestro sellador de llantas Salvamorenas tiene dos propiedades clave: actúa como protector preventivo y como sellador de llantas tras un pinchazo. Diseñado específicamente para neumáticos de vehículos pesados como camiones de carga y trailers, el Salvamorenas te ayuda a mantener tus morenas en funcionamiento sin preocuparte por las fugas de aire. Con más de 24 años de experiencia, ahora también llegamos a Dallas-Fort Worth.",
    features: [
    ...
    relatedServices: [
      { title: "Sellos de Rueda", slug: "sellos-de-rueda" },
