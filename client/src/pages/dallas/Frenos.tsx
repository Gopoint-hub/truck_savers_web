...
export default function FrenosDallas() {
  const serviceData = {
    title: "Taller de Frenos en Dallas, TX",
    subtitle: "Frenos al 100% - Protege tu carga y tu viaje en Dallas-Fort Worth",
    heroImage: "/images/thetrucksavers-4.webp",
    description:
      "En The Truck Savers Dallas, nuestro taller de frenos está especializado en la inspección, diagnóstico y reparación del sistema de frenos de camiones de carga y trailers. Con más de 24 años de experiencia, ahora también llegamos a Dallas. Nuestros mecánicos certificados utilizan equipos de diagnóstico de última generación para prevenir fallas críticas y garantizar tu seguridad en carretera.",
    features: [
    ...
    ctaText: "Agendar Inspección de Frenos en Dallas",
    location: "dallas",
  };
