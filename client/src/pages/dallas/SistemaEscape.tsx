...
export default function SistemaEscapeDallas() {
  const serviceData = {
    title: "Sistema de Escape para Camiones en Dallas, TX",
    subtitle: "Mantenimiento y reparación especializada de mofles y escape en Dallas-Fort Worth",
    heroImage: "/images/thetrucksavers-4.webp",
    description:
      "En The Truck Savers Dallas, nuestro taller se especializa en el mantenimiento, reparación y personalización del sistema de escape de camiones comerciales. Un sistema de escape en buen estado es fundamental para el rendimiento del motor, la eficiencia del combustible y el cumplimiento de las regulaciones de emisiones. Con más de 24 años de experiencia, ahora también llegamos a Dallas.",
    features: [
