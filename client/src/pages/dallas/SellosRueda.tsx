...
export default function SellosRuedaDallas() {
  const serviceData = {
    title: "Sellos de Rueda en Dallas, TX",
    subtitle: "Cambio profesional de sellos de rueda en Dallas-Fort Worth",
    heroImage: "/images/thetrucksavers-4.webp",
    description:
      "En The Truck Savers Dallas, el sello de rueda es un componente esencial que protege los baleros de la rueda, evitando fugas de lubricante y la entrada de contaminantes. En nuestro taller seguimos un procedimiento estructurado para asegurar la calidad del servicio, desde la inspección inicial hasta las pruebas finales. Con más de 24 años de experiencia, ahora también llegamos a Dallas.",
    features: [
