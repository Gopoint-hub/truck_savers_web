...
export default function SellosRuedaMonterrey() {
  const serviceData = {
    title: "Sellos de Rueda en Monterrey, N.L.",
    subtitle: "Cambio profesional de sellos de rueda - Tecnología de punta llega a Monterrey",
    heroImage: "/images/thetrucksavers-4.webp",
    description:
      "En The Truck Savers Monterrey, el sello de rueda es un componente esencial que protege los baleros de la rueda, evitando fugas de lubricante y la entrada de contaminantes. Tecnología de punta y más de 24 años de experiencia ahora disponibles en Monterrey, Nuevo León. En nuestro taller seguimos un procedimiento estructurado para asegurar la calidad del servicio.",
    features: [
    ...
    ctaText: "Agendar Cambio de Sellos en Monterrey",
    location: "monterrey",
  };
