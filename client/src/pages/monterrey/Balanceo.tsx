...
export default function BalanceoMonterrey() {
  const serviceData = {
    title: "Balanceo de Llantas en Monterrey, N.L.",
    subtitle: "Mantén tus morenas en perfecto equilibrio - Tecnología de punta llega a Monterrey",
    heroImage: "/images/thetrucksavers-7.webp",
    description:
      "En The Truck Savers Monterrey, nuestro servicio de balanceo de llantas está diseñado para garantizar que tus morenas giren de manera uniforme y sin vibraciones. Tecnología de punta y más de 24 años de experiencia ahora disponibles en Monterrey, Nuevo León. Un balanceo correcto es esencial para la seguridad, el confort de manejo y la vida útil de tus neumáticos.",
    features: [
