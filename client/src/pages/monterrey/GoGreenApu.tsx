  ...
  const serviceData = {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Sí. En muchos estados de EE.UU. y México existen regulaciones sobre emisiones. El Go Green APU permite cumplir con esas regulaciones y puede ayudarte a acceder a beneficios fiscales.",
      },
      {
