...
export default function Colaboraciones() {
  ...
  const socialLinks = [
    {
      name: "YouTube",
      url: "https://www.youtube.com/@thetrucksavers",
      icon: (
    ...
    {
      name: "Facebook",
      url: "https://www.facebook.com/thetrucksavers",
      icon: (
        <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: "Instagram",
      url: "https://www.instagram.com/thetrucksavers",
      icon: (
        <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: "TikTok",
      url: "https://www.tiktok.com/@thetrucksavers",
      icon: (
        <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: "X (Twitter)",
      url: "https://x.com/thetrucksavers",
      icon: (
        <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: "Spotify",
      url: "https://open.spotify.com/show/5Mfp2ZLzKIqWPgPXCTqJSq",
      icon: (
        <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
