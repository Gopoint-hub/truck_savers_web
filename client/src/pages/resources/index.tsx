...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt: '¿Cansado del desgaste prematuro de llantas? Descubre las 3 causas principales y las soluciones reales.',
  ...
  },
  {
    ...
    excerpt: 'Aprende a identificar la diferencia entre problemas del diferencial y la transmisión.',
  ...
  },
  {
    ...
    excerpt: 'Todo lo que necesitas saber sobre la suspensión de tu camión.',
        ...
        <div className="container">
          ...
          <div className="flex flex-wrap justify-center gap-6 max-w-3xl mx-auto">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="group flex flex-col items-center p-6 bg-gray-50 rounded-xl hover:bg-red-50 hover:shadow-lg transition-all min-w-[140px]"
            >
              <div className="w-16 h-16 bg-red-600 rounded-full flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
                <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                </svg>
              </div>
