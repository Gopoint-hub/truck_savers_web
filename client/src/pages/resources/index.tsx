      ...
      <section className="py-16 bg-gray-50 border-t">
        <div className="container">
          ...
          <div className="flex flex-wrap justify-center gap-6 max-w-3xl mx-auto">
            ...
            {/* X (Twitter) */}
            <a 
              href="https://x.com/lostrucksavers" 
              target="_blank" 
              rel="noopener noreferrer"
              className="group flex flex-col items-center p-6 bg-gray-50 rounded-xl hover:bg-gray-100 hover:shadow-lg transition-all min-w-[140px]"
            >
              ...
              <span className="font-semibold text-gray-900 group-hover:text-gray-700">X</span>
              <span className="text-sm text-gray-500">@lostrucksavers</span>
            </a>

            {/* Spotify */}
            <a 
              href="https://open.spotify.com/show/54MZRziETt1StMY7YJ4Wjp?si=6c97349e33474f48" 
              target="_blank" 
              rel="noopener noreferrer"
              className="group flex flex-col items-center p-6 bg-gray-50 rounded-xl hover:bg-green-50 hover:shadow-lg transition-all min-w-[140px]"
            >
              ...
              <span className="font-semibold text-gray-900 group-hover:text-green-600">Spotify</span>
